...
namespace Ceiba.ParkingLotADN.Infrastructure.Adapters {
    
    public class GenericRepository<E> : IGenericRepository<E> where E : Ceiba.ParkingLotADN.Domain.Entities.Base.DomainEntity
    {
